...
Status: release-ready pending commit/tag. `streaming::append` adds
...
is documented in [v0.6-kafka-style.md](examples/v0.6-kafka-style.md). Release
notes are documented in [v0.6.md](v0.6.md).
